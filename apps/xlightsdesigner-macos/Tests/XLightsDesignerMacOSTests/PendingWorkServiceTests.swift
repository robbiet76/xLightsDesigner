...
@Test func pendingWorkLoadsAppDesignIntentWithoutGeneratedArtifacts() throws {
    let project = ActiveProjectModel(
        id: "project-1",
        projectName: "Christmas 2026",
        projectFilePath: "/tmp/nonexistent-app-design-only/Christmas 2026.xdproj",
        showFolder: "/tmp/show",
        mediaPath: "",
    ...
    #expect(pending.translationSource == "App Design Intent")
    ...
    #expect(pending.appDesignTargetScope == "Mega tree, roofline, and window frames.")
