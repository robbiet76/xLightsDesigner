...
function buildDisplayReconciliationState({
  ...
  return {
    ...
    xlightsLayoutFingerprint: str(binding?.xlightsLayoutFingerprint || binding?.layoutFingerprint),
    layoutFingerprint: str(binding?.layoutFingerprint),
    previousXlightsLayoutFingerprint: str(binding?.previousXlightsLayoutFingerprint || binding?.previousLayoutFingerprint),
