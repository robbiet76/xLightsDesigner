...
export function buildDisplayDiscoveryGuidance(context = {}) {
  ...
  return [
    ...
    "Choose the next useful question based on what the user has already emphasized and what is still needed to support early sequencing decisions, rather than following a fixed sequence of topics.",
    "Optimize for information gain: ask the question that collapses the most important remaining uncertainty with the fewest words.",
    ...
    "Stop asking once you have enough semantic understanding to support a strong sequencing starting point. Do not chase completeness for its own sake.",
    "For the first substantive discovery reply, ask exactly one primary high-level question.",
    ...
    "If you mention specific xLights names early, keep it to one or two examples at most and only to ground the question, not to dump analysis.",
