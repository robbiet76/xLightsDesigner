...
test("native bridge runtime resolves the active app bridge", () => {
...
test("native bridge runtime normalizes dialog selections", () => {
...
test("native bridge runtime exposes file dialog bridge when available", async () => {
  const prevWindow = globalThis.window;
  globalThis.window = {
    xlightsDesignerDesktop: {
