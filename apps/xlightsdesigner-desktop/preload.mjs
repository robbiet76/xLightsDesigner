...
contextBridge.exposeInMainWorld("xlightsDesignerDesktop", {
  ...
  readProjectArtifact: (payload = {}) => ipcRenderer.invoke("xld:project-artifact:read", payload),
  writeProjectArtifact: (payload = {}) => ipcRenderer.invoke("xld:project-artifact:write", payload),
  writeProjectArtifacts: (payload = {}) => ipcRenderer.invoke("xld:project-artifacts:write", payload),
  ...
  runDesignerConversation: (payload = {}) => ipcRenderer.invoke("xld:designer:chat", payload),
  ...
  listMediaFilesInFolder: (payload = {}) => ipcRenderer.invoke("xld:media:list", payload),
