...
if (command === "dispatch-prompt") {
...
} else if (command === "get-automation-health-snapshot") {
  action = "getAutomationHealthSnapshot";
  ...
  action = "getRenderFeedbackSnapshot";
} else if (command === "set-render-observation") {
  action = "setRenderObservation";
  payload = readJsonPayload(rest);
