...
MANIFEST_FILE="${MANIFEST_FILE:-${ROOT_DIR}/specs/sequence-agent/xlights-sequencer-control-test-fixtures.manifest.json}"
ENV_FILE="${ENV_FILE:-${ROOT_DIR}/specs/sequence-agent/xlights-sequencer-control-test-fixtures.example.env}"
