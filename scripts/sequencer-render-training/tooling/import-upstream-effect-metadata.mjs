...
const sourceDir = process.argv[3]
  ...
  : resolve(process.env.XLIGHTS_EFFECT_METADATA_DIR || join(process.env.HOME || "", "Projects", "xLights", "resources", "effectmetadata"));
const registryPath = process.argv[4]
  ? resolve(process.argv[4])
  : resolve("scripts/sequencer-render-training/catalog/effect-parameter-registry.json");
const xlightsVersion = process.argv[5] || "2026.08";
