...
def build_intent_map(summary: dict, supported_effects: set[str]) -> dict:
    result = {
        "version": "1.0",
        "description": "Effect-scoped intent map derived from consolidated region summaries.",
...
def main():
    ...
    payload = build_intent_map(summary, set(args.effect))
