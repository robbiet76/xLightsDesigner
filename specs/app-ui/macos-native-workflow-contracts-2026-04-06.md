...
7. current-work focus belongs in the active page header, not in the global shell, and all workflow headers must derive from the same active project target context
