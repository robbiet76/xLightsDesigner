...
- provider selection normalization:
  - `apps/xlightsdesigner-ui/agent/audio-provider-adapters.js`
- capability normalization:
  - `apps/xlightsdesigner-ui/agent/audio-analysis-capability-adapters.js`
- service execution:
  - `apps/xlightsdesigner-ui/agent/audio-analysis-service-runtime.js`
- context validation/reconciliation:
  - `apps/xlightsdesigner-ui/agent/audio-analysis-context-runtime.js`
- canonical artifact and handoff derivation:
  - `apps/xlightsdesigner-ui/agent/audio-analyst-runtime.js`
