...
- `training-package-architecture.md`: source-of-truth architecture for portable BYO-provider training packages with three modules (audio, design principles, sequencer execution).
- `training-package-audit-2026-03-10.md`: baseline audit mapping current local training/eval assets into `training-package-v1`.
